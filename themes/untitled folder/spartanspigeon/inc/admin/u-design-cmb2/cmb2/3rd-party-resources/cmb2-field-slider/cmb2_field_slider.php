...
class OWN_Field_Slider {
	...
	public function own_slider_field( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
		...
		$field_type_object_input = $field_type_object->input( array(
			'type'       => 'hidden',
		...
		echo wp_kses( $field_type_object_input, array ( 
							'input' => array(
								'type' => array(),
								'class' => array(),
								'name' => array(),
	...
	public function setup_admin_scripts( ) {
		...
		wp_enqueue_script( 'cmb2_field_slider_js',  get_template_directory_uri() . '/inc/admin/u-design-cmb2/cmb2/3rd-party-resources/cmb2-field-slider/js/cmb2_field_slider.js', array( 'jquery', 'jquery-ui-slider' ), self::VERSION );
		...
		wp_enqueue_style( 'cmb2_field_slider_css', get_template_directory_uri() . '/inc/admin/u-design-cmb2/cmb2/3rd-party-resources/cmb2-field-slider/css/cmb2_field_slider.css', array( 'udesign-optns-slider-ui' ), self::VERSION );
