...
// color picker script
(function($) {
    if ( $('#feedbackButtonColor').length ) { // if element found
	addColPicker('#feedback_button_color', '#feedbackButtonColor', rgb2hex( $('#feedbackButtonColor div').css('background-color') ));
    }
