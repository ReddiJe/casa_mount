...
<div class="firstBlockContainer">
        <div class="firstBlockInner">
            <div class="textFirstBlock animate__animated animate__fadeInRight">
                <h2>
                    We offer <b>best racing pigeons</b> for sale
                </h2>
                <h1>
                    Spartan Racing Pigeons
                </h1>
                <p>
                    Welcome to Spartan Racing Pigeons web site where we will be offering, For Sale Proven Performance Racing Pigeons with News and Advice to fellow Pigeon Fanciers World Wide.
                </p>
                <a href="#" class="buttonFirstBlockText">Pigeons for sale</a>
            </div>
        </div>
        <a href="#" class="arrowBottom">
            <p href="#">More Info</p>
            <img src="<?php echo get_bloginfo( 'template_directory' ); ?>/assets/images/Arrow 1.png" alt="">
        </a>
        <div class="socialLinks">
            <a href="#">
                <img src="<?php echo get_bloginfo( 'template_directory' ); ?>/assets/images/youtube.png" alt="">
            </a><a href="#">
                <img src="<?php echo get_bloginfo( 'template_directory' ); ?>/assets/images/facebook.png" alt="">
            </a>
        </div>
    </div>
    ...
    <div class="newsBlock">
        ...
        <div class="newsCardsContainer">
            ...
            foreach( $my_posts as $post ){
                ...
                ?>
	            <div class="newsCard">
                    <img src="./images/pigeonNews.png" alt="">
                    <h1 class="newsTitle">
                        <?php the_title() ; ?>
                    </h1>
                    <p class="newsContent">
