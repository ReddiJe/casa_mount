...
<body>
    <header>
        <div class="navigationDesctopLogo">
        <a href="#" class="openHeaderDesctop buttonForDesctop" onclick="openHeaderDesctop()"><i class="fa-solid fa-bars"></i></a>
        <a href="#" class="closeheaderDesctop buttonForDesctop" onclick="closeHeaderDesctop()">X</a>
		...
		<?php wp_nav_menu( [
					...
					'items_wrap'      => '<ul class="newClassForMobile forIpad">%3$s</ul>',
				] ); ?>
    ...
    <script>
        let openButtonDesctop = document.querySelector(".openHeaderDesctop")
        let closeheaderDesctop = document.querySelector(".closeheaderDesctop")
        let navigationDesctop = document.querySelector(".sideNavigation")

        openHeaderDesctop = () => {
            openButtonDesctop.style.display = "none";
            closeheaderDesctop.style.display = "block";
            navigationDesctop.style.display = "flex"
        }

        closeHeaderDesctop = () => {
            openButtonDesctop.style.display = "block";
            closeheaderDesctop.style.display = "none";
            navigationDesctop.style.display = "none"
        }
    </script>
