...
class Elementor_titleWithButton extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Title With Button', 'elementor-addon');
    }
...
?>
        ...
        <div class="richText">
            ...
            <a href="<?php echo $settings['button-url']; ?>" class="button">
