...
<div class="infoAboutSection">
    ...
    <div class="longTimeline wow fadeInUp">
        <div class="longTimeStep" style="background-image: url(http://localhost/wp-content/uploads/2023/11/Group-83.png);">
            <h3>
        ...
        <div class="longTimeStep" style="background-image: url(http://localhost/wp-content/uploads/2023/11/Group-82.png);">
            <h3>
        ...
        <div class="longTimeStep" style="background-image: url(http://localhost/wp-content/uploads/2023/11/Group-81.png);">
            <h3>
