...
class Elementor_accommodationsList extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Accommodation List', 'elementor-addon');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Accommodation List', 'elementor-addon'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
            ...
            <?php foreach ($accommodations as $accommodation) { ?>
                <div class="accomodation">
                    ...
                    <div class="accomodationText">
                        ...
                        <a href="<?php echo $accommodation['url']; ?>">Go To Options
